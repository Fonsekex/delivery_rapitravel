...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-tracker-tracker-module"], {
  ...
  function srcAppPagesTrackerTrackerPageTs(module, __webpack_exports__, __webpack_require__) {
      ...
      _createClass(TrackerPage, [{
        ...
        value: function getOrder() {
          ...
          this.api.getOrderById(this.id).then(function (data) {
            ...
            if (data) {
              ...
              _this2.dCover = data.uid.coverImage;
              _this2.dId = data.dId.uid;
              _this2.restAddress = data.address.address;
              _this2.phone = data.dId.phone;
              _this2.status = data.status;
              _this2.grandTotal = data.grandTotal;
              _this2.totalOrders = JSON.parse(data.order); // this.getDriverInfo();
        ...
        value: function loadMap(latOri, lngOri, latDest, lngDest) {
          ...
          this.interval = setInterval(function () {
            _this3.changeMarkerPosition(marker, map);
          }, 12000);
        }
      }, {
        key: "ionViewDidLeave",
    ...
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"], src_app_services_api_service__WEBPACK_IMPORTED_MODULE_3__["ApiService"], _angular_fire_firestore__WEBPACK_IMPORTED_MODULE_4__["AngularFirestore"], src_app_services_util_service__WEBPACK_IMPORTED_MODULE_5__["UtilService"]])], TrackerPage);
    /***/
  },
