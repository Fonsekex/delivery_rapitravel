...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~pages-profile-profile-module~profile-profile-module"], {
  ...
  function srcAppPagesProfileProfilePageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var ProfilePage = /*#__PURE__*/function () {
      function ProfilePage(router, api, navCtrl) {
        ...
        value: function getProfile() {
          ...
          this.api.getProfile(localStorage.getItem('uid')).then(function (data) {
            ...
            if (data) {
              ...
              _this.avtar = data.coverImage;
              _this.phone = data.phone;

              _this.api.getMyReviews(localStorage.getItem('uid')).then(function (data) {
                console.log('-->-->', data);
    ...
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"], src_app_services_api_service__WEBPACK_IMPORTED_MODULE_3__["ApiService"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["NavController"]])], ProfilePage);
    /***/
  }
}]);
