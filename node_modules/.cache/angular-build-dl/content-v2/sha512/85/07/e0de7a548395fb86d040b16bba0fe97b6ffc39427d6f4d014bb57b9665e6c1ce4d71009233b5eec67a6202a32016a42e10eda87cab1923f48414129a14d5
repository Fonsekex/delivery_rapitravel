...
const routes = [
    ...
    {
        path: 'orders',
        loadChildren: () => Promise.all(/*! import() | pages-orders-orders-module */[__webpack_require__.e("default~orders-orders-module~pages-orders-orders-module"), __webpack_require__.e("pages-orders-orders-module")]).then(__webpack_require__.bind(null, /*! ./pages/orders/orders.module */ "./src/app/pages/orders/orders.module.ts")).then(m => m.OrdersPageModule)
    },
    {
        path: 'order-detail',
        loadChildren: () => Promise.all(/*! import() | pages-order-detail-order-detail-module */[__webpack_require__.e("default~pages-login-login-module~pages-order-detail-order-detail-module"), __webpack_require__.e("pages-order-detail-order-detail-module")]).then(__webpack_require__.bind(null, /*! ./pages/order-detail/order-detail.module */ "./src/app/pages/order-detail/order-detail.module.ts")).then(m => m.OrderDetailPageModule)
    },
    {
        path: 'profile',
        loadChildren: () => Promise.all(/*! import() | pages-profile-profile-module */[__webpack_require__.e("default~pages-profile-profile-module~profile-profile-module"), __webpack_require__.e("pages-profile-profile-module")]).then(__webpack_require__.bind(null, /*! ./pages/profile/profile.module */ "./src/app/pages/profile/profile.module.ts")).then(m => m.ProfilePageModule)
    },
    {
        path: 'edit-profile',
    ...
    {
        path: 'analysis',
        loadChildren: () => __webpack_require__.e(/*! import() | pages-analysis-analysis-module */ "pages-analysis-analysis-module").then(__webpack_require__.bind(null, /*! ./pages/analysis/analysis.module */ "./src/app/pages/analysis/analysis.module.ts")).then(m => m.AnalysisPageModule)
    },
    {
        path: 'tracker',
...
let AppComponent = class AppComponent {
    constructor(platform, splashScreen, statusBar, geolocation, api, translate, oneSignal, nativeAudio, actionSheetController, util) {
...
/* harmony import */ var _ionic_native_native_audio_ngx__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! @ionic-native/native-audio/ngx */ "./node_modules/@ionic-native/native-audio/ngx/index.js");
...
AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        ...
        imports: [
            ...
            angularfire2__WEBPACK_IMPORTED_MODULE_12__["AngularFireModule"].initializeApp(src_environments_environment__WEBPACK_IMPORTED_MODULE_14__["environment"].firebase),
        ...
        providers: [
            ...
            _ionic_native_native_audio_ngx__WEBPACK_IMPORTED_MODULE_19__["NativeAudio"],
...
AuthGuard = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [src_app_services_api_service__WEBPACK_IMPORTED_MODULE_3__["ApiService"], _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"]])
], AuthGuard);
...
let ApiService = ApiService_1 = class ApiService {
    ...
    login(email, password) {
        return new Promise((resolve, reject) => {
            this.fireAuth.auth.signInWithEmailAndPassword(email, password)
                ...
                .catch(err => {
                this.authInfo$.next(ApiService_1.UNKNOWN_USER);
    ...
    getMyReviews(id) {
        return new Promise((resolve, reject) => {
            this.adb.collection('driverreviews', ref => ref.where('dId', '==', id)).get().subscribe((review) => tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
...
module.exports = __webpack_require__(/*! D:\delivery_rapitravel\delivery_rapitravel\src\main.ts */"./src/main.ts");
