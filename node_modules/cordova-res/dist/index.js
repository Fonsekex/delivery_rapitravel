...
async function CordovaRes(options = {}) {
    ...
    const { directory, resourcesDirectory, logstream, errstream, platforms, projectConfig, skipConfig, copy, resizeOptions, } = { ...defaultOptions, ...options };
    ...
    for (const platform of platform_1.PLATFORMS) {
        ...
        if (platformOptions) {
            const platformResult = await platform_1.run(platform, resourcesDirectory, platformOptions, resizeOptions, errstream);
