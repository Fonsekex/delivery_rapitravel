...
import { ImageSchema, ResizeOptions } from './image';
 ...
 */
export declare function run(platform: Platform, resourcesDirectory: string, options: Readonly<RunPlatformOptions>, resizeOptions: ResizeOptions, errstream: NodeJS.WritableStream | null): Promise<RunPlatformResult<ResourceConfig>>;
/**
 ...
 */
export declare function safelyGenerateSimpleResources(type: ResourceType.ICON | ResourceType.SPLASH, platform: Platform, resourcesDirectory: string, options: Readonly<SimpleResourceOptions> | undefined, resizeOptions: ResizeOptions, errstream: NodeJS.WritableStream | null): Promise<GenerateResourceResult<SimpleResourceConfig> | undefined>;
/**
 ...
 * with `undefined`.
 */
export declare function generateSimpleResources(type: ResourceType.ICON | ResourceType.SPLASH, platform: Platform, resourcesDirectory: string, options: Readonly<SimpleResourceOptions> | undefined, resizeOptions: ResizeOptions, errstream: NodeJS.WritableStream | null): Promise<GenerateResourceResult<SimpleResourceConfig> | undefined>;
export declare function getResourceTransformFunction(platform: Platform, type: ResourceType, { transform, }: Readonly<SimpleResourceOptions>): TransformFunction;
 ...
 */
export declare function safelyGenerateAdaptiveIconResources(platform: Platform, resourcesDirectory: string, options: Readonly<AdaptiveIconResourceOptions> | undefined, resizeOptions: ResizeOptions, errstream: NodeJS.WritableStream | null): Promise<RunPlatformResult<ResourceConfig> | undefined>;
/**
 * Generate Android Adaptive Icons.
 */
export declare function generateAdaptiveIconResources(resourcesDirectory: string, options: Readonly<AdaptiveIconResourceOptions>, resizeOptions: ResizeOptions, errstream: NodeJS.WritableStream | null): Promise<RunPlatformResult<ResourceConfig>>;
 ...
 */
export declare function generateAdaptiveIconResourcesPortion(resourcesDirectory: string, type: ResourceKey.FOREGROUND | ResourceKey.BACKGROUND, sources: readonly (string | ImageSource)[], transform: TransformFunction | undefined, resizeOptions: ResizeOptions, errstream: NodeJS.WritableStream | null): Promise<GenerateResourceResult<UnconsolidatedGeneratedAndroidAdaptiveIconResource>>;
export declare function generateAdaptiveIconResourcesPortionFromImageSource(resourcesDirectory: string, type: ResourceKey.FOREGROUND | ResourceKey.BACKGROUND, source: ResolvedImageSource, transform: TransformFunction | undefined, resizeOptions: ResizeOptions, errstream: NodeJS.WritableStream | null): Promise<UnconsolidatedGeneratedAndroidAdaptiveIconResource[]>;
export declare function generateImageResource(resourcesDirectory: string, image: ImageSourceData, schema: ImageSchema, transform: TransformFunction | undefined, errstream: NodeJS.WritableStream | null): Promise<GeneratedImageResource>;
